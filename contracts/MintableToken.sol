...
contract MintableToken is Ownable, StandardToken {
    // Create event that logs the _to address and the amount of the token being minted.
    ...
    function mint(address _to, uint256 _amount) onlyOwner canMint public returns (bool) {
        ...
        // Execute the Transfer function inherited from the StandardToken contract to deliver the minted tokens to the _to.
